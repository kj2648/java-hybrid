        ...
        while True:
            ...
            try:
                ...
                if rc == 0:
                    ...
                    logger.info(
                        "import: scanned=%s eligible=%s imported=%s skipped_small=%s skipped_large=%s "
            ...
            if rc != 0:
                ...
                st = imported_stats
                print(f"[DSE-{wid}] imported {imported_n} inputs (eligible={st.eligible} scanned={st.scanned})")
